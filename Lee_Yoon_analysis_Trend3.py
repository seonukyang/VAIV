...
df = pd.read_excel('[전체]대선후보_유튜브_머신러닝_211129-220308_양선욱220429.xlsx', sheet_name='트렌드2')

# X = df[['Lee_gtw','Lee_ndl','Lee_kdt','Yoon_gtw','Yoon_ndl','Yoon_kdt']]
X = df[['Lee_gtw','Lee_ndl','Lee_kdt','Lee_gty','Yoon_gtw','Yoon_ndl','Yoon_kdt','Yoon_gty']]
...
Dtree = DecisionTreeRegressor(random_state=0, max_depth=4)
ANN = MLPRegressor(random_state=0, alpha=1, max_iter=1000, hidden_layer_sizes=[100,100], activation='identity')
SVR = LinearSVR(C = 5, epsilon=0.05, random_state=0)
