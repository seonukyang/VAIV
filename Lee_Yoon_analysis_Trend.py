...
X = df[['Lee_gtw','Lee_gty','Lee_ndl','Lee_kdt','Yoon_gtw','Yoon_gty','Yoon_ndl','Yoon_kdt']]
...
ANN = MLPRegressor(random_state=0, alpha=0.5, max_iter=1000, hidden_layer_sizes=[50,50], activation='identity')
SVR = LinearSVR(C = 5, epsilon=0.1, random_state=0)
